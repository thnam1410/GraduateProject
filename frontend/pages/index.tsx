	...
	return (
		<div className="flex flex-col items-center justify-center min-h-screen py-2 bg-gray-100">
			...
			<main className="flex flex-col item-center justify-center w-full flex-1 px-20 text-center"> 
				<div className="bg-white rounded-3xl shadow-2xl flex w-1/2 max-w-4xl">
					<div className="w-3/5 p-5">
						...
						<div className ="flex">
							<p className="flex items-center mr-2">Email :</p>
							<div className="bg-gray-200 w-60 p-2 flex items-center mb-3">
